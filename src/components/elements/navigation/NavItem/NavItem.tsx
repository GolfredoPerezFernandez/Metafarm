...
import { Box, Link, Popover, PopoverContent, PopoverTrigger, Stack, useColorModeValue ,Text, HStack} from '@chakra-ui/react';
    ...
    <Popover trigger={'hover'} placement={'bottom-start'}>
      <PopoverTrigger>
        <Box>
          ...
          >
            {children ? (
              label==='Home'?<Link href="https://mfarmgame.com/">
              ...
              <ChevronDownIcon /></Text>
                ...
                <HStack>
               <Text>{label}</Text>  <ChevronDownIcon />
              </HStack>
                </>
            ) : (label==='Home'?<Link href="https://mfarmgame.com/">
