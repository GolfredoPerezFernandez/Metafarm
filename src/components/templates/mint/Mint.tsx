...
const Mint = () => {
  ...
  const onCreateMarketItemBatch = async () => {
    ...
    const OPTIONS = {
      ...
      abi: nftAbi,
      params: {
        nftContract: '0x0FD2F04B0956487DF679A91480b0666b7F90FbB3',
        tokenIds,
  ...
  const onMintBatch = async () => {
    ...
    if (account !== '' && account !== undefined && account !== null) {
      ...
      await contractProcessor.fetch({
        params: OPTIONS,
        onSuccess: () => {
          alert('Collection Mint Completed!');
          resetMintBatch();
        },
        onError: (err: any) => {
          alert('FAIL check console');
      ...
      <List spacing={3}>
        <VStack justifyContent={'center'} alignItems="center">
          ...
          <Button
            ...
            size="lg"
            onClick={onCreateMarketItemBatch}
            colorScheme="yellow"
          >
            Add to Market
          </Button>
